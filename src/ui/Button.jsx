...
export default function Button({ children, disabled, to, type, onClick }) {
  ...
  const style = {
    ...
    secondary:
      ' uppercase text-sm font-semibold text-stone-400 inline-block tracking-wide rounded-full hover:bg-stone-300  focus:bg-stone-300 transition-colors duration-300 focus:outline-none focus:ring focus:ring-stone-200 focus:bg-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed border border-stone-200 px-4 py-2.5 md:px-6 md:py-3.5 hover:text-stone-800',
  };
